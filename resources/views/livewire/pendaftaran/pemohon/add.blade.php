    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" id="basic-datepicker" wire:model="tgl_lahir" class="form-control flatpickr-input active" placeholder="Tanggal Lahir Pemohon" readonly="readonly">
