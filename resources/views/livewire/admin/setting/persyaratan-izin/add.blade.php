        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group" wire:ignore>
                    ...
                    <select class="form-control select3" id="select1" wire:model="izin_id">
                        <option></option>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukan Persyaratan Pelayanan"
                        wire:model="nama_syarat">
